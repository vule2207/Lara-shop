...
<html lang="zxx">
    ...
    <body>
                                    ...
                                    <div class="cart-hover">
                                        ...
                                        <div class="select-button">
                                            <a
                                                ...
                                                class="primaty-btn view-card"
                                                >VIEW CARD</a
                                            >
                                            <a
                                                href="check-out.html"
                                                class="primaty-btn checkout-btn"
                                                >CHECK OUT</a
                                            >
                                        </div>
                                    </div>
        ...
        {{-- header section end --}} {{-- Partner Logo Section Begin --}}
        ...
        {{-- Partner Logo Section End --}} {{-- Footer section begin --}}
